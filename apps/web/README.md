...
- `NEXT_PUBLIC_SUPABASE_CAPTCHA_SITEKEY` — only if the Supabase project has CAPTCHA protection enabled; without it sign-in is rejected before the password is checked.
