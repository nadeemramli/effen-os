...
import { ClipboardCheck, GitBranch, PackageCheck, ShieldAlert, Sparkles, Truck, Undo2 } from "lucide-react";
...
// "return" is not an exception word: returned parcels have their own lane below.
const NV_EXCEPTION_WORDS = ["fail", "exception", "damaged", "lost", "on hold", "reschedule"];
...
function FulfilmentInner() {
  ...
  return (
    <PageBody className="max-w-none">
      ...
      {/* returns — Ninja Van RTS, durable rts_at (not the rollup status) */}
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <CardTitle className="flex items-center gap-2 text-sm font-medium">
