...
| 2026-08-25 | Phase 2 — Customer Base page, served lifecycle state on list/detail (migration v7) | (this commit) | Done — read-only; acquisition lens only; segment `activity` field still unversioned (Phase 3) |
