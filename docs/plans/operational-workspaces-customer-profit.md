...
| 2026-08-25 | Phase 4 — Orders New/QC (explicit `qc_state`, seven audited commands, 15-min enrolment) and server-side Drafts (migration `order_qc_v1`) | (this commit) | Done — no store write, no courier, nothing sent; reservation/release states recorded but unset until Phase 6 |
