...
| 2026-08-25 | Phase 3 — cohort workspaces (VIP / At risk / Shared address), governed `activity` in the customer list, audited follow-ups (migration `20260824221514`) | (this commit) | Done — internal follow-ups only; no consent source, no outbound send |
