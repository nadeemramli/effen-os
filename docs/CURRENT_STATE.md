...
|---|---|
| Application | 12 sidebar sections (34 section children across Orders, Customers, Fulfilment, Profit), 6 settings entries, and 50 App Router page files |
| Operational backend | 77 migration files covering 80 recorded migrations, 7 edge functions, and one plain-SQL invariant test file under `supabase/tests/` |
