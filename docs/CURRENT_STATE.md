...
|---|---|
| Application | 12 sidebar sections (35 section children across Orders, Customers, Fulfilment, Profit), 6 settings entries, and 51 App Router page files |
| Operational backend | 79 migration files covering 82 recorded migrations, 7 edge functions, and two plain-SQL invariant test files under `supabase/tests/` |
