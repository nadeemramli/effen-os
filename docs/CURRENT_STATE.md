...
|---|---|
| Application | 12 sidebar sections (29 section children across Orders, Customers, Fulfilment), 6 settings entries, and 46 App Router page files |
| Operational backend | 76 migration files covering 79 recorded migrations, 7 edge functions, and one plain-SQL invariant test file under `supabase/tests/` |
