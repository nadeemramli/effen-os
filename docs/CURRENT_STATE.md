...
|---|---|
| Application | 12 sidebar sections (28 section children across Orders, Customers, Fulfilment), 6 settings entries, and 45 App Router page files |
| Operational backend | 75 migration files covering 78 recorded migrations, 7 edge functions, and one plain-SQL invariant test file under `supabase/tests/` |
